...
# 修改默认密码
# sed -i 's/root:$1$V4UetPzk$CYXluq4wUazHjmCDBCqXF.:0:0:99999:7:::/root:[想要修改的密码掩码]:0:0:99999:7:::/g' openwrt/package/lean/default-settings/files/zzz-default-settings
